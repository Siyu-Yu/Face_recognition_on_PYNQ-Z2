...
import cv2
#-----------------------------#
#   Roughly get the face frame
#   Output bbox location and whether there is a human face
#-----------------------------#
...
class mtcnn():
    ...
    def detectFace(self, img, threshold):
        ...
        #-----------------------------#
        #   Calculate the scale of each zoom of the original input image
        #-----------------------------#
        ...
        # How to adjust the rectangle corresponding to a certain picture
        roi_prob = out[1]
